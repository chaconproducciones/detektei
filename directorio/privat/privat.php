    ...
    <div id="app" class="container">
        <div class="row">
          ...
          <div  id="web" class="col-lg-9 col-md-9 col-sm-12 pull-right">
            <!-- Init Content Web -->
              <div class="content-slider1-pages">
                  <table>
                      <tr>
                          ...
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img width="100%" height="320" src="../../img/Gewissheit-in-allen-Faellen_weiss.png" alt="Los Angeles" width="1100" height="500">
                            </div>
                            <div class="carousel-item">
                              <img width="100%" height="320" src="../../img/Gewissheit-in-allen-Faellen_weiss.png" alt="Chicago" width="1100" height="500">
                            </div>
                            <div class="carousel-item">
                              <img width="100%" height="320" src="../../img/Gewissheit-in-allen-Faellen_weiss.png" alt="New York" width="1100" height="500">
                            </div>
                          </div>
